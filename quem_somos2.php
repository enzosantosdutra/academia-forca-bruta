    ...
    <header class="header">
        <nav class="nav">
            ...
            <div class="cta-buttons">
                <a href="cadastro.php" class="btn btn-primary">Matricule-se</a>
            </div>
        </nav>
    </header>
        ...
        <div class="hero-content">
            <div class="hero-text">
                ...
                <div style="margin-top: 2rem;">
                    <a href="cadastro.php" class="btn btn-primary" style="margin-right: 1rem;">COMEÇAR AGORA 💪</a>
                    <a href="unidade2.php" class="btn btn-secondary">Unidades</a>
                </div>
            </div>
